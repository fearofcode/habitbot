...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledInstance.due_date'
        db.add_column('habits_scheduledinstance', 'due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledInstance.due_date'
        db.delete_column('habits_scheduledinstance', 'due_date')
