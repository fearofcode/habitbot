...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledInstance.completed'
        db.add_column('habits_scheduledinstance', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledInstance.completed'
        db.delete_column('habits_scheduledinstance', 'completed')
