...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.incremental'
        db.add_column('habits_goal', 'incremental',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Goal.goal_amount'
        db.add_column('habits_goal', 'goal_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.incremental'
        db.delete_column('habits_goal', 'incremental')

        # Deleting field 'Goal.goal_amount'
        db.delete_column('habits_goal', 'goal_amount')
