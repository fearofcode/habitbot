...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledInstance.current_progress'
        db.add_column('habits_scheduledinstance', 'current_progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledInstance.current_progress'
        db.delete_column('habits_scheduledinstance', 'current_progress')
