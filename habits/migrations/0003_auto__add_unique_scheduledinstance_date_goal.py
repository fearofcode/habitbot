...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ScheduledInstance', fields ['date', 'goal']
        db.create_unique('habits_scheduledinstance', ['date', 'goal_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ScheduledInstance', fields ['date', 'goal']
        db.delete_unique('habits_scheduledinstance', ['date', 'goal_id'])
