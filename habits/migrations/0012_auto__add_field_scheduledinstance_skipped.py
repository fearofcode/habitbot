...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledInstance.skipped'
        db.add_column('habits_scheduledinstance', 'skipped',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledInstance.skipped'
        db.delete_column('habits_scheduledinstance', 'skipped')
