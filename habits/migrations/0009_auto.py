...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ScheduledInstance', fields ['date']
        db.create_index('habits_scheduledinstance', ['date'])

        # Adding index on 'ScheduledInstance', fields ['due_date']
        db.create_index('habits_scheduledinstance', ['due_date'])


    def backwards(self, orm):
        # Removing index on 'ScheduledInstance', fields ['due_date']
        db.delete_index('habits_scheduledinstance', ['due_date'])

        # Removing index on 'ScheduledInstance', fields ['date']
        db.delete_index('habits_scheduledinstance', ['date'])
    ...
    models = {
        ...
        'habits.goal': {
            ...
            'dtstart': ('django.db.models.fields.DateField', [], {}),
