...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.freq'
        db.add_column('habits_goal', 'freq',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Goal.byday'
        db.add_column('habits_goal', 'byday',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.freq'
        db.delete_column('habits_goal', 'freq')

        # Deleting field 'Goal.byday'
        db.delete_column('habits_goal', 'byday')
